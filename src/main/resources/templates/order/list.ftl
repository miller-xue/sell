...
<body>
                    ...
                    <div class="col-md-12 column">
                        <table class="table table-bordered table-condensed">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/sell/seller/order/detail/${orderDTO.getOrderId()}">详情</a>
                                </td>
                                <td>
                                        <#if orderDTO.getOrderStatusEnum().message == "新订单">
                                            <a href="/sell/seller/order/cancel/${orderDTO.getOrderId()}">取消</a>
                                        </#if>
                                </td>
                            </tr>
                            </#list>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button onclick="window.reload()" type="button" class="btn btn-primary">查看新的订单</button>
                </div>
            </div>
    ...
    <script>
        ...
        if('WebSocket' in window){
            websocket = new WebSocket('ws://chs2sw.natappfree.cc/sell/webSocket');
        }else {
